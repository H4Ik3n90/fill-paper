    ...
    return (
        <div className={`h-screen ${hide === true ? "w-[5%]" : "w-[19%]"} bg-blue-dark duration-300 overflow-hidden`}>
            <div className='flex mt-2'>
                {/* <img onClick={() => setShow(!hide)} src="" alt="fill_paper_logo" className='ml-6 cursor-pointer'/> */}
...
const CurrentLink = ({to,width,height,file,text}) => {
    ...
    return(
        <Link to={to}>
            <div className={`${urlPath === to ? "bg-blue-dark-light" : ""} flex mt-2 pt-1 pb-1 rounded pl-6`}>
